...
* [Gear README](gear-readme.md) - Where the gear README template lives and how to write one — hand off to the doc-writer skill, or follow the skeleton template's own placeholders if that skill isn't installed.
